...
from main.views import HallOfFameView, TopPlacesByRegionView, TopPlacesView
...
urlpatterns = [
    ...
    path(
        "api/main/top-places/by-region/",
        TopPlacesByRegionView.as_view(),
        name="top-places-by-region",
    ),
